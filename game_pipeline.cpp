...
namespace game {
    GamePipeline::GamePipeline(
        ...
        const PipelineConfigInfo& configInfo) : gameDevice{device} {
    ...
    void GamePipeline::createGraphicsPipeline(const std::string& vertFilePath, const std::string& fragFilePath, const PipelineConfigInfo& configInfo) {
        ...
        auto bindingDescriptions = GameModel::Vertex::getBindingsDescriptions();
        auto attributeDescription = GameModel::Vertex::getAttributesDescriptions();
